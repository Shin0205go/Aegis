import { TimeBasedEnricher } from '../context/enrichers/time-based';
import { AgentInfoEnricher } from '../context/enrichers/agent-info';
import { ResourceClassifier } from '../context/enrichers/resource-classifier';
...
describe('Context Enrichers - 機能テスト', () => {
  ...
  describe('ContextCollector統合テスト', () => {
    it('全てのenricherが協調して動作する', async () => {
      const { ContextCollector } = await import('../context/collector');
